...
import TemplateFormFloating from '../../../libraries/forms_v3/templateFormFloating'
import useQueries from '../../../database/useQueries';

// ------------------------------------------------------------------ validation ---------------------------------------------------------------


const BlockFormFloating = ({
    form = [], setForm = () => {}, 
...
// * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - 
    ...
    const { setUpdateCemetery, setAddCemetery } = useQueries()
...
export default BlockFormFloating
