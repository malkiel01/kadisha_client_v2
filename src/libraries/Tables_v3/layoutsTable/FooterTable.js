...
import { Select, TableCell, TableRow, useTheme } from '@mui/material'
...
const theme = useTheme()
        ...
        return (
                <tbody>
                    <TableRow
                    // style={{...theme.titleTable}}
                    style={{ position: 'sticky', bottom: 0, zIndex: 10000}}
                    >
                        <TableCell style={{ borderRadius: '0 0 14px 0', backgroundColor: theme?.titleTable?.backgroundColor}} />
                        <TableCell
                            style={{...theme.titleTable, width: 10}} colSpan={disableSelectionOnClick ? columns.length : columns.length + 1} align="right"
                            >
                        ...
                        <TableCell style={{ borderRadius: '0 0 0 14px', backgroundColor: theme?.titleTable?.backgroundColor}} />
                    </TableRow>
                </tbody>
        )
    }
