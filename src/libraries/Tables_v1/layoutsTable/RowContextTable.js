...
//     const { row, indexRow, rowRef, setRowRef, handleKey } = props
//     const {  
//       data, 
//       columns, 
...
// //   useEffect(() => {
// //     setMyRef(rowRef)
// // //     // בכל עדכון של data, יש לבדוק שה-Ref מוכנה לשימוש
// // //     divRefs.current = Array(data.length).fill().map((_, i) => {divRefs.current[i] || React.createRef()})
// //   }, [rowRef])
...
//                 style={{border: '1px #D6F6FF solid'   ,paddingTop: 0, paddingBottom: 0, 
//                 overflow: 'hidden',
//                 maxWidth: 150
//               }}
...
//           })}
//           <OpenMenuTable 
//           value={row} menuPosition={menuPosition} menuHandle={menuHandle} anchorEl={anchorEl} handleMenuClose={handleMenuClose}
//           ></OpenMenuTable>
//           </TableRow>
//     )
