...
// עמודות לטבלת בתי עלמין
export const columnsFormPurchasesPer2Slice = createSlice({
  name: 'columnsPurchases',
  initialState: {
    data: [
      ...
      { id: 3, name: 'cemeteryId', label: 'בית עלמין', input: 'selected', width: 250, show: true, disabled: true },
      { id: 4, name: 'blockId', label: 'גוש', width: 250, input: 'selectedFree', show: true, disabled: true },
      { id: 5, name: 'plotId', label: 'מספר החלקה', input: 'selectedFree', width: 250, show: true, disabled: true },
      { id: 6, name: 'lineId', label: 'מספר שורה', input: 'selected', width: 130, show: true, disabled: true },
      { id: 7, name: 'areaGraveId', label: 'אחוזת קבר', input: 'selected', width: 120, isActive: true, show: true, disabled: true },
      { id: 8, name: 'graveId', label: 'קבר', input: 'selected', width: 120, isActive: true, show: true, disabled: true },

      { id: 9, label: 'פרטי הלקוח', isActive: true, input: 'card', show: true, lock: true },

      { id: 10, name: 'clientId', label: 'שם לקוח', input: 'selectedFree', width: 250, isActive: true, show: true },

      { id: 11, label: 'פרטי הרכישה', width: 900, isActive: true, input: 'card', show: true, lock: true },

      { id: 12, name: 'buyerStatus', label: 'סוג רכישה', input: 'selected', width: 130, isActive: true, show: true },
      { id: 13, name: 'isFuneralPayments', label: 'שירותי לוויה', input: 'selected', width: 180, show: true },
      { id: 13, name: 'diesSpouse', label: 'צמוד לבן זוג נפטר', input: 'selected', width: 180, show: true },
       
      { id: 14, name: 'price', label: 'סך תשלום', input: 'text', width: 150, isActive: true, show: true, lock: true },
      { id: 16, name: 'BookkeepingApproval', label: 'אישור הנה״ח', input: 'text', width: 120, isActive: true, show: true },
      { id: 15, name: 'PaymentEndDate', label: 'תאריך סיום תשלום', required: true, input: 'date', width: 120, isActive: true, show: true },
      ...
      { id: 25, name: 'dateOpening', label: 'תאריך פתיחת תיק', required: true, input: 'date', width: 200, isActive: true, show: true },
      { id: 26, name: 'purchaseStatus', label: 'סטטוס', input: 'selected', width: 200, isActive: true, show: true },
    ]
  },
  reducers: {
    setData(state, action) {
...
export const columnsFormPurchasesPer2Actions = columnsFormPurchasesPer2Slice.actions
